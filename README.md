...
一个简化版、单机单进程的 OpenClaw 风格 Agent Runtime，使用 Go 实现，当前阶段为 `M1`。

- 当前阶段：`M1`（见 `VERSION_STAGE`）
...
更多细节见 [doc/m1-capabilities.md](./doc/m1-capabilities.md)。
