...
- `internal/query/service.go` + `internal/query/model`: read-side query boundary. `internal/query/model` holds query-local filters, cursors, pages, and read DTOs exchanged with the store adapter.
