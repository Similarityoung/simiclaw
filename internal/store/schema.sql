...
CREATE INDEX IF NOT EXISTS idx_events_created_at_id ON events(created_at, event_id);
CREATE INDEX IF NOT EXISTS idx_events_session_created_at_id ON events(session_key, created_at, event_id);
CREATE INDEX IF NOT EXISTS idx_events_status_created_at_id ON events(status, created_at, event_id);
CREATE INDEX IF NOT EXISTS idx_runs_session_started_at ON runs(session_id, started_at);
CREATE INDEX IF NOT EXISTS idx_runs_session_key_started_at ON runs(session_key, started_at, run_id);
...
CREATE INDEX IF NOT EXISTS idx_sessions_conversation_last_activity ON sessions(conversation_id, last_activity_at, session_key);
